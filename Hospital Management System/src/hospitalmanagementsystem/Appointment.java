...
public class Appointment {
    ...
    public void bookAppointment(String department, String doctorType) {
        ...
        // Generate a bill based on the doctor's type
        generateBill(patientId, doctorType);
    }
    ...
    private void generateReport(int patientId, String doctor, ScreeningResult result) {
        // Retrieve the patient's name from the Patient object
    ...
    // Method for generating the bill based on the doctor type
    private void generateBill(int patientId, String doctorType) {
